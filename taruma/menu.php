...
<body>
    ...
    <fieldset>
        ...
        <a href="usuarios.php">Usuarios cadastrados</a>
        <a href="visualizarvistoria.php">Vistorias</a>
    </fieldset>
    <?php
    if (isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] === true) {
        ...
        if ($prioridade >= 50) { ?>
            <fieldset>
                ...
                <a href="cadastroUsuario.php">Cadastro de funcionarios</a>
                <a href="cadastroVeiculo.php">Cadastro de veiculo</a>
            </fieldset>
        <?php  } ?>
        ...
        if ($prioridade >= 15) { ?>
            <fieldset>
                ...
                <a href="vistoria.php">Vistoria</a>
